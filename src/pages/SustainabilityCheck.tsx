...
const SustainabilityCheck: React.FC = () => {
  ...
  const structuredData = {
    ...
    description:
      "Check if your business meets sustainability requirements for public sector bids",
  };
    ...
    return (
      <div className="reporting-page">
        <SEO
          ...
          canonicalUrl="https://your-domain.com/sustainability-check/results"
  ...
  return (
    <div className="reporting-page">
      <SEO
        ...
        description="Public sector contracts increasingly require compliance with sustainability standards like Net Zero commitments, Carbon Reduction Plans, and social value obligations. Use our quick self-assessment tool to check if your business meets these requirements before your bid."
        keywords="sustainability check, public sector bids, sustainability requirements"
        canonicalUrl="https://your-domain.com/sustainability-check"
        structuredData={structuredData}
      />
